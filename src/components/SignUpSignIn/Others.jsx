...
const Others = () => {
    ...
    const handleGoogleSignIn = () => {
        userSignInWithGoogle()
            ...
            .catch(() => {
                toast.error('Not Sign In via Google', {
                    position: "top-right",
                    autoClose: 5000,
                    hideProgressBar: false,
                    closeOnClick: true,
    ...
    const handleGithubSignIn = () => {
        userSignInWithGithub()
            ...
            .catch(() => {
                toast.error('Not Sign In via GitHub', {
                    position: "top-right",
                    autoClose: 5000,
                    hideProgressBar: false,
                    closeOnClick: true,
        ...
        <>
            ...
            <div className="flex flex-col items-center mb-10">
                ...
                <button onClick={handleGithubSignIn}
                    className="w-full max-w-md font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5">
